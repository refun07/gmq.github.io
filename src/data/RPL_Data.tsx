...
import CheckyOurSkillsIMG from "@/assets/rpl/few-step/one.svg";
import CheckyOurSkillsIMGMobile from "@/assets/rpl/few-step/mobile/one.svg";

import GetPortfolioGuidanceIMG from "@/assets/rpl/few-step/GetPortfolioGuidanceIMG.svg";
import GetPortfolioGuidanceIMGMobile from "@/assets/rpl/few-step/mobile/two.svg";

import GetaSkillsReviewIMG from "@/assets/rpl/few-step/GetaSkillsReviewIMG.svg";
import GetaSkillsReviewIMGMobile from "@/assets/rpl/few-step/mobile/three.svg";

import GetCertifiedIMG from "@/assets/rpl/few-step/GetCertifiedIMG.svg";
import GetCertifiedIMGMobile from "@/assets/rpl/few-step/mobile/four.svg";
...
import map_NTImg from "@/assets/rpl/map_NT.png";
import map_QIDImg from "@/assets/rpl/map_QID.png";
import map_SAImg from "@/assets/rpl/map_SA.png";
import map_TAZImg from "@/assets/rpl/map_TAZ.png";
...
export const RPL_SliderData = {
  ...
  items: [
    ...
    },
    {
      ...
      description: [
        "Once one of our partner registered training organizations (RTOs) has assessed your portfolio, the assessor assigned to your case may be in touch if any additional evidence is required. If you have any weak areas, the RTO may assign a trainer to up skill you at no cost to you.",
      ],
      link: {
        text: "more info",
        href: "/",
...
export const RPL_QualificationData = {
  title: "All qualifications are awarded by our partner RTO’s",
  link: {
    text: "view qualifications",
    href: "#RPL_Qualification",
  },
  RPL_QualificationItems: [
...

    {
      ...
      link: {
        text: "find more",
        href: "/rpl/informationtechnology",
      },
      show: 2,
      content: {
...

    {
      ...
      content: {
        ...
        link: [
          ...
          {
            id: 2,
            text: "This particular course of a certificate iii in plumbing is open to plumbers who have at least 5 years related local experience, as well as local students who have completed part of their studies in Au....",
            img: CPCrnd,
            description:
              "The Roof Plumbing certificate course offers both core and elective units that cover the basic competency requirements needed by the plumbing industry, as well as the units required to qualify as a roo....",
            href: "#",
...

    {
      ...
      RPL_Img: RetailServices,
    },
  ],
};

export const RPL_SkillsTextData = {
  one: {
    title: "What industry is your experience in?",
    title_two: "What qualification are you looking for?",
    selection: [
      {
        id: 1,
      ...
      {
        id: 6,
        selection: "Commercial Cookery Hospitality",
        value: true,
        suggester: [
          {
            id: 1,
      ...
      {
        id: 9,
        selection: "Events Entertainment",
        value: true,
        suggester: [
          {
            id: 1,
      ...
      {
        id: 11,
        selection: "Horticulture Land Management",
        value: true,
        suggester: [
          {
            id: 1,
      ...
      {
        id: 18,
        selection: "Vocational Education Training",
        value: true,
        suggester: [
          {
            id: 1,
  ...
  two: {
    title: "How many years of relevant work experience do you have?",
    title_two: "Where is your work experience?",
    workExperience: [
      {
        id: 1,
        year: "1-2",
  ...
  four: {
    title: "Do you have any formal qualifications?*",
    formal_qualification: [
      {
        id: 1,
        assert: <AiOutlineCheck size="25" />,
        text: "yes",
      },
      {
        id: 2,
        assert: <FaTimes size="25" />,
        text: "No",
      },
    ],
    what_qualifications: {
  ...
  five: {
    ...
    terms_and_contrition: `I understand and accept the websites <a href='#' style="color:green;"><u> terms and conditions </u></a> and <a href='#' style="color:green;"> <u>privacy policy</u></a>. I agree that GMQ may contact me about the services it provides.`,
  },
};
