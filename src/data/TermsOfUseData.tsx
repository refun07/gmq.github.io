export const TermsOfUseDummyData = {
  title: "Terms of Use",
  body: `
...
<h3 class="titleOfParagraph">Using our web site</h3>

<p class="part">When using this web site you agree to be legally bound by these terms and conditions as they may be modified and posted to our web site from time to time. Without prejudice to the above, by using or accessing our website, you agree to be legally bound by these terms and conditions of use as they apply to your use of or access to our website. If you do not wish to be bound by these terms and conditions then you may not use our website. You must ensure that the personal information you provide is accurate and complete and that all ordering or registration details (where applicable) contain your correct name, address and other requested details. For more information about how we deal with your personal information, please read our privacy policy on this website.</p>

<br />

<h3 class="titleOfParagraph">Applicability of online materials</h3>

<p class="part">Unless otherwise specified the materials published on our web site are presented solely for your private, personal and non-commercial use. We have used our reasonable endeavours to ensure that our web site complies with Globaln law. However, we make no representations that the materials on our web site are appropriate or available for use in locations outside of Global. We make no warranties, express or implied that making the Products available in any particular jurisdiction outside of Global is permitted under any applicable non-Globaln laws or regulations. Accordingly, if making the Products or any part thereof available in your jurisdiction or to you (by reason of nationality, residence or otherwise) is prohibited, those Products are not offered for sale to you. You accept that if you are resident outside of Global, you must satisfy yourself that you are lawfully able to purchase the Products. We accept no liability, to the extent permitted by applicable law, for any costs, losses or damages resulting from or related to the purchase or attempted purchase of the Products by persons in jurisdictions outside of Global or who are nominees of or trustees for citizens, residents or nationals of other countries.</p>

<br />

<h3 class="titleOfParagraph">Copyright &amp; monitoring</h3>

<p class="part">The contents of our web site are protected by international copyright laws and other intellectual property rights. We, or other third party licensors, are the owner of these rights. All product and company names and logos mentioned in our web site are the trade marks, service marks or trading names of their respective owners, including us. You may download material from our web site for the sole purpose of using it as a information resource for our real estate services. However, you may not modify, copy, reproduce, republish, upload, post, transmit or distribute, by any means or in any manner, any material or information on or downloaded from our web site including, but not limited to text, graphics, video, messages, code and/or software without our prior written consent, except where expressly invited to do so, for example in order to complete any test or questionnaire.</p>

<br />

<h3 class="titleOfParagraph">Linked sites</h3>

<p class="part">We make no representations whatsoever about any other web sites which you may access through our web site or which may link to our web site. When you access any other web site you understand that it is independent from us and that we have no control over the content or availability of that web site. In addition, a link to any other site does not mean that we endorse or accept any responsibility for the content, or the use of, such a web site and shall not be liable for any loss or damage caused or alleged to be caused by or in connection with use of or reliance on any content, goods or services available on or through any other web or resource. Any concerns regarding any external link should be directed to its web site administrator or web master.</p>
