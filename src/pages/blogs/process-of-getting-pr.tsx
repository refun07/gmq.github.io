...
export const blogData = [
    {
        ...
        title1: "PR Pathway IT Courses in Australia",
        about4: {
        ...
        title3: "How to Obtain Permanent Residency in Australia Through IT Courses?",
        description3: "Unlike other industries, Australia's IT industry is quickly increasing, with consistent job growth. The Tech Council of Australia has urged the government to ease skilled migration for IT workers, citing a 60% higher vacancy rate in IT professions than the national average.This offers an appealing path to permanent residency for tech-savvy foreigners seeking stable employment in Australia.",
        ...
        title4: "Visa Options.",
        description4: "IT professionals and graduates have access to an extensive selection of visa options other than a student visa.These include permanent visas that permit the holder to work and reside in Australia permanently, as well as temporary graduate visa options.",
    ...
    return (
        ...
        <div className="max-w-screen-2xl mx-auto mt-10">
            ...
            <div className="mt-4 space-y-6 p-5">
                ...
                <div>
                    <h1 className="text-3xl font-bold mb-2">{firstBlog?.about5?.title}</h1>
                    <p className="text-gray-700 text-lg">{firstBlog?.about5?.description}</p>
                </div>
                <div>
                    <h1 className="text-3xl font-bold mb-2">{firstBlog?.about6?.title}</h1>
                    <p className="text-gray-700 text-lg">{firstBlog?.about6?.description}</p>
                </div>
                <div>
                    <h1 className="text-3xl font-bold mb-2">{firstBlog?.about7?.title}</h1>
                ...
                <div>
                    <h1 className="text-3xl font-bold mb-2">{firstBlog?.about8?.title}</h1>
                    <p className="text-gray-700 text-lg">{firstBlog?.about8.description}</p>
                </div>
                <div>
                    <h1 className="text-3xl font-bold mb-2">{firstBlog?.about9?.title}</h1>
                    <p className="text-gray-700 text-lg">{firstBlog?.about9?.description}</p>
                </div>
                <div>
                    <h1 className="text-3xl font-bold mb-2">{firstBlog?.about10?.title}</h1>
                    <p className="text-gray-700 text-lg">{firstBlog?.about10?.description}</p>
                </div>

                <h1 className="text-4xl font-bold">{firstBlog?.title4}</h1>
                <div className="mt-2 p-2">
                    <p className="text-gray-700 text-lg mb-4">{firstBlog?.description4}</p>
                </div>
                <div>
                    <h1 className="text-3xl font-bold mb-2">{firstBlog?.about11?.title}</h1>
                    <p className="text-gray-700 text-lg">{firstBlog?.about8.description}</p>
                </div>
                <div>
                ...
                <h1 className="text-4xl font-bold">{firstBlog?.title6}</h1>
                <div className="mt-2 p-2">
                    <p className="text-gray-700 text-lg mb-4">{firstBlog?.description6}</p>
                </div>
                <div>
                ...
                <div>
                    <h1 className="text-3xl font-bold mb-2">{firstBlog?.about18?.title}</h1>
                    <p className="text-gray-700 text-lg">{firstBlog?.about18?.description}</p>
                </div>
                <div>
                    <h1 className="text-3xl font-bold mb-2">{firstBlog?.about19?.title}</h1>
